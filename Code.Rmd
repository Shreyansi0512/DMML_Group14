...
```{r, fig.show="hold", out.width = '45%', fig.cap = "\\label{fig:bar} Barplots of Selected Categorical Variables"}
...
```{r,  fig.pos = "H", out.width = '50%', fig.cap = "\\label{fig:tree} Decision Tree", fig.align = "center"}
...
Different machine learning models were built to predict the success of the marketing campaigns undertaken by the portuguese banking institution. Based on sensitivity criteria as the selection criteria, model built using Gradient Boosting was chosen. The model predicts with `r result.gbm.test[4]`% accuracy. The results show that the probability of 'no' is more than a 'yes'. This indicates that the marketing campaign is not extremely effective. 
